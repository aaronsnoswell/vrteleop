...
public:
    ...
    ros::Subscriber sub;
    ros::Publisher pub;
    void cloudCallback(const vrteleop::CompressedPointCloud2::ConstPtr& cloud_msg);
};
 ...
 */
void Decompression::cloudCallback(const vrteleop::CompressedPointCloud2::ConstPtr& msg)
{
...
int main (int argc, char** argv)
{
    ...
    // Create our filter
    Decompression MyObj;
    const boost::function< void(const vrteleop::CompressedPointCloud2::ConstPtr &)> boundCloudCallback = \
